...
// JSON URL
let url = URL(string: "https://api.coingecko.com/api/v3/coins/markets?vs_currency=twd&ids=ethereum&order=market_cap_desc&per_page=10&sparkline=true&price_change_percentage=24")
